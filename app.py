        ...
        if st.button("ENTRAR NA ARENA"):
            if nome and senha_digitada:
                ...
                if nome_upper == "TREINAMENTOWLI":
                    st.error("Use a opção de perfil Administrator para acessar com este nome.")
                else:
                    try:
...
if st.session_state.jogador == "TREINAMENTOWLI":
    ...
    # --- MONITORAMENTO EM TEMPO REAL DO FIM DO JOGO ---
    try:
    ...
    # REDIRECIONAMENTO AUTOMÁTICO PARA O PÓDIO FINAL COM BALÕES
